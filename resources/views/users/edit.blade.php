    ...
    <div class="container py-4">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0"><i class="bi bi-person-gear me-2"></i>Edit User</h4>
            </div>
            <div class="card-body">
                <form id="editUserForm" action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="saldo" name="saldo" value="{{ number_format($user->saldo, 0, ',', '.') }}" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        ...
                        <div class="preview-container">
                            <img id="imagePreview" src="{{ $user->foto ? asset('storage/fotos/'.$user->foto) : '#' }}" 
                                 style="{{ $user->foto ? 'display: block;' : 'display: none;' }}" alt="Preview">
                        </div>
                    </div>
